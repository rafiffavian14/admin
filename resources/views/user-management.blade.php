    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img style="width: 100px; margin-bottom: 150px;"
                        src="{{asset('assets/img/logo-siasn.png')}}"></a>
                <a style="color: #00997a; font-family: 'Poppins', sans-serif; font-size: 30px; margin-top: 8px"
                    class="navbar-nav" href="{{ route('index') }}">SI ASN BKN</a>
            </div>
